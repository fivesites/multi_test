...
export default function AboutSectionText({
  ...
  return (
    ...
    >
      <h1
        className={`font-visual text-6xl lg:text-8xl max-w-3xl uppercase leading-none text-center lg:text-left font-normal tracking-tight lg:tracking-tighter lg:leading-[0.9] ${lineColor}`}
      >
        <TypedWord text={plainText} visible={phase !== "p1"} />
      </h1>
      {text && (
        <p
          className={`font-visual text-xl lg:text-2xl tracking-normal max-w-5xl font-medium leading-[1.1] lg:leading-[1.2] mt-1 text-center lg:text-left lg:tracking-wide lg:font-normal lg:indent-16 lg:mt-2 ${lineColor}`}
        >
      ...
      <Link
        ...
        className={`font-visual text-3xl lg:text-5xl w-full uppercase mt-16 leading-[1] lg:indent-16 font-medium lg:tracking-wide lg:mt-2 max-w-sm hover:text-lyx transition-colors text-center lg:text-left lg:max-w-3xl  ${lineColor}`}
      >
        <TypedWord text="connect" visible={phase !== "p1"} delay={ctaDelay} />
      </Link>
    </div>
  );
}
