...
export default function ColorButton({
  ...
  const labelEl = labelSide ? (
    <span className="shrink-0 cursor-pointer font-visual text-base font-normal tracking-wide lowercase text-primary">
      {label}
    </span>
  ) : null;
  ...
  return (
    ...
    >
      ...
      <motion.span
        className="flex h-2 w-2 lg:h-2 lg:w-2 shrink-0 overflow-hidden border border-current"
        initial={false}
