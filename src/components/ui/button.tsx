...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-x-2 w-min    font-normal whitespace-nowrap transition-all outline-none font-visual cursor-pointer focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-red-700 text-red-300 ",
        destructive:
      ...
      size: {
        default:
          "h-auto px-0 py-0 has-[>svg]:px-3  leading-tight tracking-wide text-3xl lg:text-lg font-normal",
